...
import com.smileidentity.sample.activity.V12Activity
...
fun SettingsScreen(
    ...
    BottomPinnedColumn(
        ...
        scrollableContent = {
            ...
            Button(
                onClick = {
                    context.startActivity(Intent(context, V12Activity::class.java))
                },
            ) {
                Text(text = stringResource(R.string.settings_show_v12))
            }
        },
        pinnedContent = {
            SelectionContainer {
