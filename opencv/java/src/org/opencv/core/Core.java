...
public class Core {
    ...
    private static String getVersion() { return "4.11.0"; }
    private static String getNativeLibraryName() { return "opencv_java4110"; }
    private static int getVersionMajorJ() { return 4; }
    private static int getVersionMinorJ() { return 11; }
