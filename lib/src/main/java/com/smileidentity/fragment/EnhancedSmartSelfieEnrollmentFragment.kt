 ...
 *
 * A [Fragment] wrapper for the [SmartSelfieEnrollmentEnhanced] to be used if not using Jetpack
 ...
 *   this,
 *   (requestKey, result) -> {
 *     SmartSelfieResult smartSelfieResult = EnhancedSmartSelfieEnrollmentFragment
...
class EnhancedSmartSelfieEnrollmentFragment : Fragment() {
    companion object {
        const val KEY_REQUEST = "EnhancedSmartSelfieEnrollmentRequest"
         ...
         */
        internal const val KEY_RESULT = "EnhancedSmartSelfieEnrollmentRequest"
