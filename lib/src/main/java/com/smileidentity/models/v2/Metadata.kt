...
open class Metadatum(
     ...
     */
    @Parcelize
    data class SelfieCaptureDuration(val duration: @RawValue Duration) :
     ...
     */
    @Parcelize
    data class DocumentFrontCaptureDuration(val duration: @RawValue Duration) :
     ...
     */
    @Parcelize
    data class DocumentBackCaptureDuration(val duration: @RawValue Duration) :
