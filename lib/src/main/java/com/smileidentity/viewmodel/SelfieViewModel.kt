...
class SelfieViewModel(
...
) : BaseSubmissionViewModel<SmartSelfieResult>() {
    ...
    // the new
    override fun createSubmission(): BaseJobSubmission<SmartSelfieResult> {
    ...
    override fun handleSuccess(data: SmartSelfieResult) {
