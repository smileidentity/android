...
import com.smileidentity.compose.metadata.models.WrapperSdkName
...
object SmileID {
    ...
    fun submitJob(
        ...
        val authRequest = moshi.adapter(AuthenticationRequest::class.java)
            ...
            ?: run {
                Timber.v(
                    "Error decoding AuthenticationRequest JSON to class: " + authRequestJsonString,
                )
        ...
        if (authRequest.jobType == JobType.BiometricKyc ||
            ...
            val savedUploadRequestJson = moshi.adapter(UploadRequest::class.java)
                ...
                ?: run {
                    Timber.v(
                        "Error decoding UploadRequest JSON to class: " + uploadRequestJson,
                    )
                    throw IllegalArgumentException("Invalid jobId information")
                }
